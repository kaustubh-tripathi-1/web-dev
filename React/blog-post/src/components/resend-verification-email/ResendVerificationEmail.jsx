                ...
                >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            } shadow-sm hover:shadow-xl rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 focus:border-transparent`}
                            disabled={loading}
                            autoComplete="email"
                            ...
                            <input
                                ...
                                className={`w-full px-3 py-2 border ${
                                    errors.password
                                        ? "border-red-500"
                                        : "border-gray-300 dark:border-gray-600"
                                } rounded-md shadow-sm hover:shadow-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 focus:border-transparent`}
                                disabled={loading}
