...
export default function SearchModalContent() {
    ...
    return (
        <div className="flex flex-col gap-4 animate-fade-in">
            <form onSubmit={handleSubmit(searchOnSubmit)} className="relative">
                <input
                    type="text"
                    ...
                    className="w-full px-4 py-2 text-gray-900 dark:text-gray-100 bg-gray-100 dark:bg-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300"
                />
                {searchQuery && (
                    <button
                        onClick={handleClear}
